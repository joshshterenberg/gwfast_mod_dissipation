...
_LABELS = {
    ...
    'hs': r'$\mathcal{H}_{s}$',
    'ha': r'$\mathcal{H}_{a}$',
    'hs3': r'$\mathcal{H}_{s^3}$',
    'ha3': r'$\mathcal{H}_{a^3}$',
    'h0': r'$\mathcal{H}_0$',
    'h1': r'$\mathcal{H}_1$',
    'h1bar': r'$\overline{\mathcal{H}}_1$',
    'h3': r'$\mathcal{H}_3$',
    'h3bar': r'$\overline{\mathcal{H}}_3$',
    'flux_ratio': r'$\mathcal{F}_{\rm H}/ \mathcal{F}_{\infty}$',
    'hs_E': r'$\mathcal{H}_{s}^E$',
